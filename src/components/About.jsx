...
const About = () => {
  return (
    <div className="py-16 flex items-center justify-center" id="about" data-aos="fade-up">
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-center">
        <img src={Work} alt="Work" className="rounded w-[250px] h-[250px] items-center" />
        <div className="md:ml-8 mt-4 md:mt-0 md:w-[300px] about">
          <h4 className="text-3xl font-semibold">About Me</h4>
          <p className="text-sm text-[#90909E] mt-4 ">
